...
public class navigationBarController implements Initializable, ControlledScreen{
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            Logger.getLogger(navigationBarController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void goToLogout(ActionEvent event)throws IOException{   
        ...
        verifyLogout verifyLogoutController = loader.getController();
        Stage logout_stage = new Stage();
        logout_stage.initModality(Modality.APPLICATION_MODAL);
        logout_stage.initStyle(StageStyle.UNDECORATED);
        logout_stage.setScene(new Scene(root));
        logout_stage.showAndWait();
        
        if (verifyLogoutController.pp) {
            ...
            verifyLogoutController.setBoolean(false);
        }
